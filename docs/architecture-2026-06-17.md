...
**Status:** current
**Author:** generated from a verified codebase sweep (not from prior docs)
...
- **Doc drift.** Several overlapping architecture docs already exist (`architecture.md`,
  `arch.md`); see the recommendation accompanying this file.
